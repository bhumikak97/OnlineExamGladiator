...
<body>
	<nav id="nav_bar">
		<ul class="nav_ul">
			<li class="nav_list float_left"><a href=""
				class="nav_link active">Home</a></li>
	...
	<div class="logo_div">
		<img src="resources/logo.png" id="exam_logo"><br>
		<p id="logo_label">Runtime tERRORs</p>
		<p id="logo_description">An easy way to test your skills!</p>
	</div>
</body>
</html>